...
Then it is supposed to be more readable!
    ...
    assert response.get("createTest").get("test").get("testType").get("name") == "Cucumber"
...
- check result
    ...
    assert response.get("createTest").get("test").get("issueId")
    assert response.get("createTest").get("test").get("jira").get("key")
    assert response.get("createTest").get("test").get("testType").get("name") == "Generic"
...
def test__xray_tests__create_manual_test(jaxa_client):
    ...
    assert response.get("createTest").get("test").get("issueId")
    assert response.get("createTest").get("test").get("jira").get("key")
    assert response.get("createTest").get("test").get("testType").get("name") == "Manual"
