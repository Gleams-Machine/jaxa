...
def test__jira_links__add_link(jirasync_client):
    ...
    req_jiiraid = jirasync_client.gql.tests.get_jirakeyid_from_createtest_result(requirement)

    jirasync_client.jira.links.add_link(ticket_id=test_jiiraid, outward_issue_id=req_jiiraid)
