...
class JAXAContextData:
    ...
    def record_testset(self, *, testset_id: str, testset_key: str, summary: str = "") -> None:
    ...
    def record_testexecution(self, *, testexecution_id: str, testexecution_key: str, summary: str = "") -> None:
    ...
    def record_testrun(self, *, testrun_id: str, test_id: str, testexecution_id: str) -> None:
